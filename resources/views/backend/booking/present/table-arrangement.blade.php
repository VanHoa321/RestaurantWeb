                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Đơn đặt bàn của <span class="text-info">{{ $booking->customer->full_name }} - {{ $booking->customer->phone }}</span> - với {{ $booking->guest_count }} khách
                                </h3>
                            </div>
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="row g-0">
                                                                        <div class="col-4 d-flex align-items-center justify-content-center border-right">
                                                                            <a href="{{ route('post.table', ['id' => $booking->id, 'table_id' => $table->id]) }}"><h4 class="fw-bold text-info" style="font-weight: 600">{{ $table->name }}</h4></a>
                                                                        </div>
                                                                        <div class="col-8">                              
