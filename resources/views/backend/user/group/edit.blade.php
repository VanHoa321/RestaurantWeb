                            ...
                            <form method="post" action="{{route("group.update", $edit->id)}}" id="quickForm">
                                ...
                                <div class="card-body">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="Nhập tên nhóm quyền">
                                    </div>
                                    <div class="form-group">
            ...
            $('#quickForm').validate({
                ...
                messages: {
                    name: {
                        ...
                        minlength: "Tên nhóm quyền phải có ít nhất {0} ký tự!",
                        maxlength: "Tên nhóm quyền tối đa {0} ký tự!"
                    }             
                },
                errorElement: 'span',
