                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('user.index') }}" class="text-info">Nhân viên</a></li>
                                            ...
                                            <tr id="user-{{ $item->id }}">
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                        <input type="checkbox" class="custom-control-input IsActive" id="customSwitch{{ $item->id }}" {{ $item->is_active ? 'checked' : '' }} value="{{ $item->id }}" {{ $item->group_id == 1 ? 'disabled' : '' }}>
                                                        <label class="custom-control-label" for="customSwitch{{ $item->id }}"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{route('user.show', $item->id)}}" class="btn btn-info btn-sm" title="Xem thông tin nhân viên">
