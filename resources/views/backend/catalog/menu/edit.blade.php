                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Chỉnh sửa thực đơn</li>
                        </ol>               
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Nhập tên thực đơn" value="{{old('name', $edit->name)}}">
                                                </div> 
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Vị trí</label>
                                                    <input type="number" name="order_menu" class="form-control" placeholder="Nhập vị trí hiển thị" value="{{old('order_menu', $edit->order_menu)}}">
                                                </div> 
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" id="menu-items-data" value="{{ json_encode($menu_items) }}">
                                                <input type="hidden" id="menu-id-edit" value="{{ $edit->id }}">
                                            </div>
                                        </div>                                                                  
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var ids = {};
            var existingItems = JSON.parse($("#menu-items-data").val());
