                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Chỉnh sửa cơ sở</li>
                        </ol>               
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("branch.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                           
                                    <div class="form-group">
                                        <label>Tên cơ sở nhà hàng</label>
                                        <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="Nhập tên cơ sở nhà hàng">
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <input type="text" name="address" value="{{ old('address', $edit->address) }}" class="form-control" placeholder="Nhập địa chỉ cơ sở nhà hàng">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Số điện thoại</label>
                                                <input type="text" name="phone" value="{{ old('phone', $edit->phone) }}" class="form-control" placeholder="Nhập số điện thoại cơ sở nhà hàng">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" name="email" value="{{ old('email', $edit->email) }}" class="form-control" placeholder="Nhập email cơ sở nhà hàng">
                                            </div>
                                        </div>
                                    </div>                                                               
                                    <div class="form-group">
