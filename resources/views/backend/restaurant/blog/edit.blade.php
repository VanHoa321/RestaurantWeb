                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("blog.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                                                               
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="blog_category_id" class="form-control select2bs4">
                                                            @foreach($categories as $cate);
                                                                <option value="{{$cate->id}}" {{ old('blog_category_id', $edit->blog_category_id) == $cate->id ? 'selected' : '' }}>{{$cate->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>                         
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" class="form-control mb-3" name="content" placeholder="Nhập nội dung bài viết">{{ old('content', $edit->content) }}</textarea>
                                    </div>                                                                                                                                                                                                                 
                                </div>
