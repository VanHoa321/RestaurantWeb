                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Chỉnh sửa loại bàn</li>
                        </ol>               
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("table-type.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                                                               
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="Nhập tên loại bàn">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Chỗ ngồi tối đa</label>
                                                <input type="number" name="max_seats" value="{{ old('max_seats', $edit->max_seats) }}" class="form-control" placeholder="Nhập chỗ ngồi tối đa">
                                            </div>
                                        </div>
                                    </div>                                                               
                                    <div class="form-group">
