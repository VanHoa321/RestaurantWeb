                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active text-info"><a href="{{ route('item-category.index') }}" class="text-info">Danh mục mặt hàng</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <a type="button" class="btn btn-success" href="{{route('item-category.create')}}">
                                ...
                                <table id="example-table" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @php
                                            $counter = 1;
                                        @endphp
                                        @foreach ($itemCategoties as $item)
                                            <tr id="itemCategory-{{ $item->id }}">
                                                ...
                                                <td>
                                                    <a href="{{route('item-category.edit', $item->id)}}" class="btn btn-info btn-sm" title="Sửa danh mục mặt hàng">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="{{ $item->id }}" title="Xóa danh mục mặt hàng">
