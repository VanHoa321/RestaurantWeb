@extends('layout/admin_layout')
    @section('title', 'Thêm mới danh mục mặt hàng')
    @section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route("admin-menu.index") }}">Quản lý danh mục mặt hàng</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Thêm mới danh mục mặt hàng</h3>                               
                            </div>
